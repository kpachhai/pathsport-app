export const fr = {
  developertools: {
    ...
    'provide-mnemonic':
      "Veuillez fournir un DID d'application existant, ou en créer un nouveau",
    ...
    'different-did':
      "Différent de l'utilisateur courant. Publier pour mettre à jour.",
    'uploading-icon':
      "Envoie de l'icône de l'application vers le stockage Hive du développeur, veuillez patienter...",

    // Placeholders
    'redirecturl-placeholder':
      'Saisir votre "redirect url" ici si vous en avez une',
    'nativecustomscheme-placeholder':
      'Saisir votre "custom scheme" ici si vous en avez un',
    'nativecallbackurl-placeholder':
      'Saisir votre "callback url" ici si vous en avez une',
