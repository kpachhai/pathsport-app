export const fr = {
  didsessions: {
    ...
    'mnemonicpasscheck-question':
      'Avez-vous un mot de passe pour votre mnémonique?',
    ...
    // Create screen
    'welcome-message1':
      "Bienvenue dans l'internet moderne, dans lequel vous prenez le contrôle de votre identité numérique.",
    'welcome-message2':
      'Vous pouvez désormais gérer votre identité et vérifier celle des autres, sans devoir fournir toutes vos données à un tiers.',
    ...
    'create-message':
      'Créez une toute nouvelle identité ou importez une identité que vous possédez déjà',
    new: 'Nouvelle',
    import: 'Importer',
    ...
    'import-prompt':
      'Veuillez saisir vos 12 mots secrets pour importer votre identité',
    ...
    // retrieve identities
    'retrieve-prompt':
      'Recherche et importation des identités, veuillez patienter.',
    ...
    'print-confirmation-des':
      'Avez-vous réussi à imprimer le QR code de votre identité?',
    ...
    prepare: {
      ...
      'publish-intro':
        'Cette étape est indispensable et prend quelques secondes, veuillez patienter.',
      'sign-in-title': 'Connexion',
      'sign-in-intro': 'Entrée en cours dans Pathsport',
      ...
      'done-intro':
        'Votre identité est maintenant prête. Vous pouvez commencer à utiliser Pathsport.',
    },
  },
};
