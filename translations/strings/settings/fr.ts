export const fr = {
  settings: {
    ...
    'about-setting': "A propos d'Pathsport",
    ...
    'startupscreen-intro-setting':
      "Choix de l'écran à afficher au démarrage d'Essentials",
    ...
    'switch-network-prompt':
      "L'application doît redémarrer après avoir modifié le réseau",
    ...
    'wallet-connect-popup':
      "Opération terminée, veuillez retourner sur l'application d'origine.",
    'wallet-connect-session-disconnected': 'Session Wallet connect terminée',
    'wallet-connect-error':
      "Une application externe vient d'envoyer une demande non prise en charge par Pathsport.",
    'raw-request': 'Requête brute: ',
    'wallet-connect-request-loading':
      'Tentative de connexion à une application externe via Wallet Connect',
    'wallet-connect-request-error1':
      'Il semble que le lien ne puisse pas être établi. Veuillez ',
    'get-a-new-qr-code': 'générer un nouveau QR code',
    'wallet-connect-request-error2':
      " dans l'application d'origine et le scanner à nouveau.",
    ...
    'wallet-connect-request-des':
      "Souhaitez-vous vous connecter à l'application suivante?",
    ...
    'wallet-connect-no-session-info':
      "Il n'y a actuellement pas de connexion avec une appli tierce via Wallet Connect. Trouvez le boutton Wallet Connect dans l'application externe, et scannez le QR code fourni, avec le scanner Pathsport.",

    /********** Startup Screen Page **********/
    startupscreen: 'Ecran de démarrage',
    'startupscreen-home-title': 'Accueil Essentials',
    'startupscreen-home-description':
      'Ecran par défaut avec toutes les fonctionnalités et les widgets.',
    ...
    'publish-identity-medium-assist':
      'Publier les identités rapidement via le service tiers ASSIST',
    'publish-identity-medium-wallet':
      'Publier les identités en utilisant mon portefeuille',

    'elastos-api-provider': "Fournisseur d'API Elastos",
    'elastos-api-provider-des':
      'Sélectionnez votre fournisseur pour les services Elastos',
    'elastos-io-des':
      "Ensemble de services déployés et maintenus par l'équipe Elastos Fusion de la fondation Elastos, aussi connue comme l'équipe Produit.",
    'trinity-tech-cn-des':
      "Ensemble de services déployés et maintenus par l'équipe Trinity Tech de la fondation Elastos, responsable du développement des SDK d'Elastos.",
