export const defaultContacts = [
  'did:elastos:iabbGwqUN18F6YxkndmZCiHpRPFsQF1imT', // Chen Rong
  // 'did:elastos:iXyYFboFAd2d9VmfqSvppqg1XQxBtX9ea2', // Trinity Tech
  // 'did:elastos:insTmxdDDuS9wHHfeYD1h5C2onEHh3D8Vq', // Benjamin Piette, Trinity Tech
  ...
  // 'did:elastos:ipsGDumwoBti6iwPF8rWHqFg2ishQ9yHdH', // Waqas Ahmed, Tuum Tech
];
