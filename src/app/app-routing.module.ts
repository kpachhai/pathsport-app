...
const routes: Routes = [
  ...
  {
    path: 'didsessions',
    loadChildren: './didsessions/module#DIDSessionsModule',
  },
  { path: 'scanner', loadChildren: './scanner/module#ScannerModule' },
  {
    path: 'hivemanager',
    loadChildren: './hivemanager/module#HiveManagerModule',
  },
  ...
  {
    path: 'developertools',
    loadChildren: './developertools/module#DeveloperToolsModule',
  },
